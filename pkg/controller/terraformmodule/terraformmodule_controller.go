...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Uncomment watch a Deployment created by TerraformModule - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &corev1beta1.TerraformModule{},
	})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=core.kubeterra.io,resources=terraformmodules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=core.kubeterra.io,resources=terraformmodules/status,verbs=get;update;patch
